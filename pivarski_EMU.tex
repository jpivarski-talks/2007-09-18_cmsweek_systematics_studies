...
%% \begin{center}
%% \only<1>{\includegraphics[height=0.85\linewidth, angle=90]{events_x_rmsonly.pdf}

%% \includegraphics[height=0.85\linewidth, angle=90]{events_y_rmsonly.pdf}}
%% \only<2>{\includegraphics[height=0.425\linewidth, angle=90]{events_phix_rmsonly.png}\mbox{\hspace{0.425\linewidth}}

%% \includegraphics[height=0.85\linewidth, angle=90]{events_phiy_rmsonly.pdf}}
%% \only<3>{\includegraphics[height=0.85\linewidth, angle=90]{events_z_rmsonly.pdf}
